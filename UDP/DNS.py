...
class DnsClient:
    ...
    def response(self, packet):
        dnsHeader = packet[:12]
        dnsData = packet[12:].split(b'\x00', 1) #DNS 쿼리 문에서 00 기준으로 자르기
    ...
    def query(self):
        ...
        sock.sendto(query, addr) #만든 쿼리 보내기
